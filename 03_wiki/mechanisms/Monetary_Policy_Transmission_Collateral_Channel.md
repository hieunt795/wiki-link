...
tags: [monetary-transmission, collateral, repo, QE, shadow-banking, plumbing]

confidence: 3
stability: stable

thesis: >
  Repo rates — which reflect collateral availability and quality — guide the policy rate more
  directly than unsecured interbank rates. QE, by removing high-quality collateral from circulation
  and replacing it with reserves, suppresses collateral velocity and may impair monetary transmission:
  large CB footprint in collateral markets weakens the market signals that normally guide policy.
