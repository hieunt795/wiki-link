...
· ε t không tự tương quan với chính nó. Và các biến ngoại sinh X không có hiện tượng đa cộng tuyến, tức là các biến X không tương quan chặt với nhau. Khi các điều kiện trên thỏa mãn, ta sẽ có ước lượng điểm không chệch của các hệ số ước lượng αi , βi , γ i , từ

đó dự báo cho biến Y .
...
Ví dụ về chuỗi tự tương quan Trong mô hình chuỗi thời gian, tính dừng được xem như ổn định và có thể dự báo (có quy luật). Nếu các chuỗi đưa vào mô hình (Chuỗi hành vi hoặc kinh tế vĩ mô) không dừng, cần biến đổi để các chuỗi dừng. Sai phân: Sai phân của một chuỗi y có dạnh như sau:
...
2. Giả thiết H0: biến X không ảnh hưởng đến biến Y Giả thiết H1: biến X ảnh hưởng đến biến Y p-value ≤ 0.05 thì bác bỏ H0, chấp nhận biến X trong mô hình
...
```
Code: grangertest(runoff, vnibor_6m, order = 365)$`Pr(>F)`[2] P-value kiểm định chuỗi drawdown với VNIBOR_6M = 0.283017295 > 0.05
```
...
VNINDEX = α0 + α1VNIBOR\_6M + ε  → VIFvnindex

VNIBOR\_6M = α0 + α1VNINDEX + ε → VIFvnibor6m
...
| Có d = 1, p, q lớn nhất bằng 5, ta sẽ có 5 mô hình ARIMAX là:   | Có d = 1, p, q lớn nhất bằng 5, ta sẽ có 5 mô hình ARIMAX là:   | Có d = 1, p, q lớn nhất bằng 5, ta sẽ có 5 mô hình ARIMAX là:   | Có d = 1, p, q lớn nhất bằng 5, ta sẽ có 5 mô hình ARIMAX là:   | Có d = 1, p, q lớn nhất bằng 5, ta sẽ có 5 mô hình ARIMAX là:   | Có d = 1, p, q lớn nhất bằng 5, ta sẽ có 5 mô hình ARIMAX là:   |
|-----------------------------------------------------------------|-----------------------------------------------------------------|-----------------------------------------------------------------|-----------------------------------------------------------------|-----------------------------------------------------------------|-----------------------------------------------------------------|
...
- Kiểm định tính dừng cho phần dư Nếu phần dư không dừng, loại bỏ  tổ hợp mô hình
...
|      |   FORECAST |   ACTUA L C |   WAPE D |   MAPE |
|------|------------|-------------|----------|--------|
| 0.42 |       0.25 |       -0.17 |    -0.66 |     19 |
| 0.89 |       0.85 |       -0.05 |    -0.06 |     20 |
| 0.68 |       0.35 |       -0.33 |    -0.96 |     21 |
| 0.76 |       0.65 |       -0.11 |    -0.16 |     22 |
| 0.62 |       0.62 |        0.00 |     0.00 |     23 |
| 0.92 |       0.34 |       -0.58 |    -1.72 |     24 |
| 0.88 |       0.62 |       -0.26 |    -0.42 |     25 |
| 0.49 |       0.51 |        0.02 |     0.04 |     26 |
| 0.07 |       0.24 |        0.17 |     0.72 |     27 |
| 0.44 |       0.86 |        0.42 |     0.49 |     28 |
...
Dải kì hạn 1 ngày (b = 1) có giá trị dòng tiền ra cộng dồn = 1 - 0.79 = 0.21

Dải kì hạn 2 - 7 ngày (b = 7) có giá trị dòng tiền ra cộng dồn = 1 - 0.79*0.84*0.88*0.95*0.95*0.93*0.86 = 0.58
...
H0: ρ1 = ρ2 = … = ρk = 0 , tức là không có tự tương quan

H1: Có ít nhất 1 ρi ≠ 0

Xét thống kê

Q tiệm cận phân bố Khi bình phương χ 2 với bậc tự do (k - p - q) trong đó
...
Nếu Q &gt; χ (k-p-q) 2 thì bác bỏ H0, tức là phần dư có tự tương quan
...
S ≠ 0 và K ≠ 3 , Chuỗi không phân bố chuẩn
